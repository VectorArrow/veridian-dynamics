...
function sendMail($to, $message){ 
    ...
    $subject = "Veridian Dynamics Confirmation: " . $todaysDate ;

    // be sure to change Your Site and yoursite to something meaningful
    $mailFrom = "Veridian Dynamics <autoresponse@veridiandyanmics.com>";

    $cc = "";  // ex: $cc = "webmaster@yoursite.com";
    $bcc = ""; // ex: $bcc = "swreinha@yoursite.com";

    /* message */
    $messageTop  = '<html><head><title>' . $subject . '</title></head><body>';
    $mailMessage = $messageTop . "
        Thank you for your interest in a job at Veridian Dynamics.
        We will review your application promptly. If we find your application fits 
        our needs, we will contact you again, generating a 229 protocol. If you 
        pass that as well, please bring the 457 code we will supply you into 
        the Veridian Dynamics Human Resource department.". $message;
